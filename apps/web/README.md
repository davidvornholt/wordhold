...
If pronunciation generation fails, the dashboard retries it automatically. The learner never has to know which speech provider failed or start the retry by hand.
